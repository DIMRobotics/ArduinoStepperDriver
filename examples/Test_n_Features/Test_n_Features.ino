...
void setup()
{
   ...
   * это значение-заглушка
   */
  left = StepperDriver.newAxis(1, 2, 3);
  right = StepperDriver.newAxis(4, 5, 6);
...
void loop()
{
   ...
   *   Скорость конвертируется в длину шага по закону:
   *    / 0, если скорость - 0 (отсутствие шагов)
   *    \ 65535/speed в ином случае.
